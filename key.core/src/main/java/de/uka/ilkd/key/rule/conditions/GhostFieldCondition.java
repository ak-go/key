 ...
 */
public class GhostFieldCondition extends VariableConditionAdapter {

    private final SchemaVariable field;
    private final boolean negated;

    public GhostFieldCondition(SchemaVariable field, boolean negated) {
        this.field = field;
    ...
    public boolean check(SchemaVariable var, SVSubstitute subst,
        ...
        if (var == field) {
            ...
            return (negated ^ attribute.isGhost()) &&
