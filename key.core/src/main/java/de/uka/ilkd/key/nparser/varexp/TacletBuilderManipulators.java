...
public class TacletBuilderManipulators {
    ...
    public static final AbstractConditionBuilder GHOST_FIELD =
            new ConstructorBasedBuilder("isGhostField", GhostFieldCondition.class, FSV);
    ...
    static {
        register(SAME_OBSERVER, SIMPLIFY_ITE_UPDATE, ABSTRACT_OR_INTERFACE, SAME, IS_SUBTYPE,
            ...
            STATIC_FIELD, MODEL_FIELD, GHOST_FIELD, SUBFORMULA, DROP_EFFECTLESS_STORES, EQUAL_UNIQUE,
            META_DISJOINT,
